/**
 * SMARTTECH ELECTRONICS - ASSETS CONFIGURATION FILE
 * 
 * Edit this file to add, modify, or remove product images, gallery photos,
 * and descriptions displayed across the website.
 */
